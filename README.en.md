...
- [**Scheduler**](apps/scheduler/README.en.md) — Task scheduling and job orchestration.
- [**Workers**](apps/workers/README.en.md) — Asynchronous processing and intensive tasks.

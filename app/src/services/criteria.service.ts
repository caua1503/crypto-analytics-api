...
export class CriterionWeightService {
  ...
  async create(data: CriterionWeightCreateType): Promise<CriterionWeightType> {
    try {
      ...
      const criterionWeight = await this.prisma.criterionWeight.create({ data: validatedData });
  ...
  async update(id: number, data: Partial<CriterionWeightCreateType>): Promise<CriterionWeightType> {
    try {
